...
def main(
    ...
    # set the seed here since some randomizations happen during environment initialization
    ...
    # optionally switch to path tracing for higher-quality rendering (e.g. for videos)
